...
typedef bj_window* (*bj_window_create_window_fn)(struct bj_system_backend_t*, const char*, uint16_t, uint16_t, uint16_t, uint16_t, uint8_t);
...
typedef int (*bj_window_get_size_fn)(struct bj_system_backend_t*, const bj_window*, int*, int*);
typedef bj_bitmap* (*bj_window_create_framebuffer_fn)(struct bj_system_backend_t*, const bj_window*, bj_error** p_error);
typedef void (*bj_window_flush_framebuffer_fn)(struct bj_system_backend_t*, const bj_window*);
