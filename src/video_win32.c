...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (uMsg) {
        ...
        case WM_KEYUP: {
            ...
            bj_push_key_callback((bj_window*)p_window, action, keycode, scancode);
        ...
        case WM_LBUTTONDOWN:
        case WM_LBUTTONUP:
            bj_push_button_callback((bj_window*)p_window, 
                BJ_BUTTON_LEFT,
        ...
        case WM_MOUSEMOVE: {
            ...
            if(!p_window->cursor_in_window) {
                ...
                bj_push_enter_callback((bj_window*)p_window, 1, x, y);
            }
            ...
            tme.hwndTrack = hwnd;
            TrackMouseEvent(&tme);
            bj_push_cursor_callback((bj_window*)p_window, x, y);
            break;
        }

        case WM_MOUSELEAVE: {
            p_window->cursor_in_window = 0;
            bj_push_enter_callback((bj_window*)p_window, 0, 0, 0);
            break;
        }
