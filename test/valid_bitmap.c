...
int main(int argc, char* argv[]) {
    ...
    RUN_TEST_ARGS(valid_bitmap, .name = "bmp/test/valid/4bpp-topdown-320x240.bmp");
    ...
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/32bpp-101110-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/32bpp-888-optimalpalette-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-1x1.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-320x240-topdown.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-321x240-topdown.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-321x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-322x240-topdown.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/565-322x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle4-absolute-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle4-alternate-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle4-delta-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle4-encoded-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle8-64000x1.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle8-absolute-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle8-blank-160x120.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
    RUN_TEST_ARGS(invalid_bitmap, .name = "bmp/test/valid/rle8-delta-320x240.bmp", .code=BJ_ERROR_INCORRECT_VALUE);
