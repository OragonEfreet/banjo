...
static BJ_INLINE struct bj_vec2 bj_vec2_map(
    struct bj_vec2 a,
    bj_real(*f)(bj_real)
) {
    return (struct bj_vec2){ .x = f(a.x), .y = f(a.y), };
}
...
///
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_add(struct bj_vec2 lhs, struct bj_vec2 rhs) {
    return (struct bj_vec2){ .x = lhs.x + rhs.x, .y = lhs.y + rhs.y, };
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_add_scaled(
    struct bj_vec2 lhs,
    struct bj_vec2 rhs,
    bj_real s
) {
    return (struct bj_vec2){ .x = lhs.x + rhs.x * s, .y = lhs.y + rhs.y * s, };
}
...
/// \return `lhs` - `rhs`
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_sub(
    const struct bj_vec2 lhs,
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_scale(struct bj_vec2 v, bj_real s) {
    return (struct bj_vec2){ .x = v.x * s, .y = v.y * s, };
}
...
/// \return The result of `v * s`
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_mul_comp(
    const struct bj_vec2 v,
    const struct bj_vec2 s
) {
    return (struct bj_vec2){ .x = v.x * s.x, .y = v.y * s.y, };
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec2_dot(struct bj_vec2 a, struct bj_vec2 b) {
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec2_perp_dot(struct bj_vec2 a, struct bj_vec2 b) {
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec2_len(struct bj_vec2 v) {
...
/// \param v Input vector.
/// \param L Desired length of the result.
/// \warning Undefined if the input vector has zero length.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_scale_to_len(struct bj_vec2 v, bj_real L){
    const bj_real l = bj_vec2_len(v); 
    if (bj_real_is_zero(l)){
        return (struct bj_vec2){BJ_FZERO,BJ_FZERO};
    }
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec2_distance_sq(struct bj_vec2 a, struct bj_vec2 b) {
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec2_distance(const struct bj_vec2 a, const struct bj_vec2 b) {
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_normalize(struct bj_vec2 v){
    const bj_real l2 = v.x * v.x + v.y * v.y;
    if (bj_real_is_zero(l2)) {
        return (struct bj_vec2){ BJ_FZERO, BJ_FZERO };
    }
    const bj_real inv = BJ_F(1.0) / bj_sqrt(l2);
    return (struct bj_vec2){ v.x * inv, v.y * inv };
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_normalize_unsafe(struct bj_vec2 v) {
...
/// \param b Input component or vector b.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_min(struct bj_vec2 a, struct bj_vec2 b) {
    return (struct bj_vec2){a.x < b.x ? a.x : b.x, a.y < b.y ? a.y : b.y, };
}
...
/// \param b Input component or vector b.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec2 bj_vec2_max(struct bj_vec2 a, struct bj_vec2 b) {
    return (struct bj_vec2){a.x > b.x ? a.x : b.x, a.y > b.y ? a.y : b.y, };
}

static BJ_INLINE struct bj_vec3 bj_vec3_map(
    struct bj_vec3 a,
    bj_real(*f)(bj_real)
) {
    return (struct bj_vec3){ .x = f(a.x), .y = f(a.y), .z = f(a.z), };
}
...
/// \param rhs Right-hand input vector.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_add(struct bj_vec3 lhs, struct bj_vec3 rhs) {
...
/// \return Sum of `lhs` and `rhs * s`.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_add_scaled(
    struct bj_vec3 lhs,
    struct bj_vec3 rhs,
    bj_real s
) {
...
/// \return `lhs` - `rhs`
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_sub(
    struct bj_vec3 lhs,
    struct bj_vec3 rhs
) {
    return (struct bj_vec3){ 
...
/// \return The result of `v * s`
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_scale(struct bj_vec3 v, bj_real s) {
    return (struct bj_vec3){ 
        .x = v.x * s,
        .y = v.y * s,
        .z = v.z * s,
...
/// \returns The scalar dot product.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec3_dot(struct bj_vec3 a, struct bj_vec3 b) {
...
/// \returns The Euclidean norm.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec3_len(struct bj_vec3 v) {
...
/// \warning Undefined if the input vector has zero length.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_scale_to_len(struct bj_vec3 v, bj_real L){
    const bj_real l = bj_vec3_len(v);
    if (bj_real_is_zero(l)) {
        return (struct bj_vec3){BJ_FZERO,BJ_FZERO,BJ_FZERO};
    }
...
/// \returns The squared distance ||a - b||^2.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec3_distance_sq(struct bj_vec3 a, struct bj_vec3 b) {
    const bj_real dx = a.x - b.x;
    const bj_real dy = a.y - b.y;
...
/// \returns The Euclidean distance ||a - b||.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec3_distance(struct bj_vec3 a, struct bj_vec3 b) {
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_normalize(struct bj_vec3 v){
    const bj_real l2 = v.x * v.x + v.y * v.y + v.z * v.z;
    if (bj_real_is_zero(l2)) {
        return (struct bj_vec3){ BJ_FZERO, BJ_FZERO, BJ_FZERO };
    }
    const bj_real inv = BJ_F(1.0) / bj_sqrt(l2);
    return (struct bj_vec3){ v.x * inv, v.y * inv, v.z * inv };
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_normalize_unsafe(struct bj_vec3 v) {
...
/// \param b Input component or vector b.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_min(struct bj_vec3 a, struct bj_vec3 b) {
    return (struct bj_vec3){
        a.x < b.x ? a.x : b.x,
        a.y < b.y ? a.y : b.y,
        a.z < b.z ? a.z : b.z,
...
/// \param b Input component or vector b.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_max(struct bj_vec3 a, struct bj_vec3 b) {
    return (struct bj_vec3){a.x > b.x ? a.x : b.x, a.y > b.y ? a.y : b.y, a.z > b.z ? a.z : b.z,};
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_cross(struct bj_vec3 l, struct bj_vec3 r)
{
    return (struct bj_vec3) {
        .x = l.y * r.z - l.z * r.y,
        .y = l.z * r.x - l.x * r.z,
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec3 bj_vec3_reflect(struct bj_vec3 v, struct bj_vec3 n)
{
...
static BJ_INLINE struct bj_vec4 bj_vec4_map(
    struct bj_vec4 a,
    bj_real(*f)(bj_real)
) {
    return (struct bj_vec4){ .x = f(a.x), .y = f(a.y), .z = f(a.z), .w = f(a.w), };
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_add(struct bj_vec4 lhs, struct bj_vec4 rhs) {
...
/// \return Sum of `lhs` and `rhs * s`.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_add_scaled(
    struct bj_vec4 lhs,
    struct bj_vec4 rhs,
    bj_real s
) {
...
/// \return `lhs` - `rhs`
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_sub(
    struct bj_vec4 lhs,
    struct bj_vec4 rhs
) {
    return (struct bj_vec4){ 
...
/// \return The result of `v * s`
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_scale(struct bj_vec4 v, bj_real s) {
    return (struct bj_vec4){ 
        .x = v.x * s,
        .y = v.y * s,
        .z = v.z * s,
...
/// \returns The scalar dot product.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec4_dot(struct bj_vec4 a, struct bj_vec4 b) {
...
/// \returns The Euclidean norm.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE bj_real bj_vec4_len(struct bj_vec4 v) {
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_normalize(struct bj_vec4 v) { 
    const bj_real len2 = v.x * v.x + v.y * v.y + v.z * v.z + v.w * v.w;
    if (bj_real_is_zero(len2)) { 
        return (struct bj_vec4){ BJ_FZERO, BJ_FZERO, BJ_FZERO, BJ_FZERO };
    }
    const bj_real inv = BJ_F(1.0) / bj_sqrt(len2);
    return (struct bj_vec4){ v.x * inv, v.y * inv, v.z * inv, v.w * inv };
}
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_normalize_unsafe(struct bj_vec4 v) {
...
/// \param b Input component or vector b.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_min(struct bj_vec4 a, struct bj_vec4 b) {
    return (struct bj_vec4){
        a.x < b.x ? a.x : b.x,
        a.y < b.y ? a.y : b.y,
        a.z < b.z ? a.z : b.z,
...
/// \param b Input component or vector b.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_max(struct bj_vec4 a, struct bj_vec4 b) {
    return (struct bj_vec4){
        a.x > b.x ? a.x : b.x,
        a.y > b.y ? a.y : b.y,
        a.z > b.z ? a.z : b.z,
...
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_cross_xyz(struct bj_vec4 l, struct bj_vec4 r){
    return (struct bj_vec4){ 
        l.y*r.z - l.z*r.y,
        l.z*r.x - l.x*r.z,
        l.x*r.y - l.y*r.x,
...
/// \note The normal \p n should be normalized for a true reflection.
////////////////////////////////////////////////////////////////////////////////
static BJ_INLINE struct bj_vec4 bj_vec4_reflect(struct bj_vec4 v, struct bj_vec4 n)
{
