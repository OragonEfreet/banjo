...
static uint64_t pcg32_u64(bj_pcg32_t *g) {
...
int main(int argc, char* argv[]) {
    ...
    /* discard/jump-ahead */
    bj_pcg32_t gA = (bj_pcg32_t){0};
    bj_pcg32_t gB = (bj_pcg32_t){0};
